...
{
    $article = $user->create_article($_POST['title'], $uid, $_POST['category'], $_POST['article']);
    if ($article) 
    {
...
<div id="jayc_container">
  ...
  <div id="site_title">
        ...
        <div id="jayc_menu">
            <ul>
                <li><a href="create.php" class="current">Create Article</a></li>
                    ...
                    <p>
                      ...
                      <textarea rows="4" cols="50" name="article" required></textarea></td>
                            ...
                            <tr>
                                ...
                                <td class="style3">
                                    <br />
                        <input type="submit" name="publish" value="Publish"/></td>
                            </tr>
                        </table>
                    </form>
                        </p>
