<%@ Page Title="" Language="C#" MasterPageFile="~/VP.Master" AutoEventWireup="true" CodeBehind="VPProfile.aspx.cs" Inherits="DHELTASSYSMEGABYTE.WebForm6" %>
...
<div class="modal fade" id="filterModal" tabindex="-1" role="dialog" aria-labelledby="filterModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <asp:Button ID="btnSave" runat="server" Text="Done" onclick="btnSave_Click" class="btn btn-primary" />
