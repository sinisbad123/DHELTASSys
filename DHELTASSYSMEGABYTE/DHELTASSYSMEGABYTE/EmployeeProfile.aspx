<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="EmployeeProfile.aspx.cs" Inherits="DHELTASSYSMEGABYTE.WebForm21" %>
...
<div class="modal fade" id="filterModal" tabindex="-1" role="dialog" aria-labelledby="filterModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
             ...
             <asp:Button ID="btnSubmit" runat="server" Text="Done" onclick="btnSubmit_Click" class="btn btn-primary" />
