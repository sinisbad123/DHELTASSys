<%@ Page Title="" Language="C#" MasterPageFile="~/DHELTAEMP/Employee.Master" AutoEventWireup="true" CodeBehind="EmployeeProfile.aspx.cs" Inherits="DHELTAFINALPROJECT.DHELTAEMP.WebForm2" %>
...
<div class="containerFluid">
    <div class="mainContainer">
        ...
        <asp:GridView ID="gvSupervisor" runat="server" CssClass="table table-striped table-bordered table-condensed">
                </asp:GridView>
