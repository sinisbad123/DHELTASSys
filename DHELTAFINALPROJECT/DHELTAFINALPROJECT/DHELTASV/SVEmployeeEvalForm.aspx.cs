...
namespace DHELTASSYSMEGABYTE
{
    public partial class SVEmployeeEvalForm : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "Success", "<script type='text/javascript'>alert('You have successfully completed the evaluation!');window.location='SVEmployeeEvaluate.aspx';</script>'");        
        }
    }
}