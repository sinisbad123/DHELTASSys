<%@ Page Title="" Language="C#" MasterPageFile="~/DHELTASV/Supervisor.Master" AutoEventWireup="true" CodeBehind="SVEmployeeEvalForm.aspx.cs" Inherits="DHELTASSYSMEGABYTE.SVEmployeeEvalForm" EnableEventValidation="false"%>
        ...
        <div class="mainContent">
            <div class="humanresource">
                ...
                <p style="text-align:center;">
                    INSTRUCTION: Complete the evaluation by answering the following questions. Please check the answer that best describes your satisfaction with your employee.
                    <br>
                    <br>
                    Ratings:<br>
                ...
                <asp:GridView ID="gvEmployeeEvalForm" runat="server" CssClass="table table-striped table-bordered table-condensed">
                    <Columns>
